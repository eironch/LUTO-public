        ...
        >
            <div className="flex flex-col gap-3 justify-center items-center w-5/12 overflow-hidden model-inner">
                ...
                <div className="flex flex-col w-full rounded-3xl bg-zinc-900 overflow-hidden">
                    ...
                    {/* feedback input */}
                    <div className="flex flex-row p-6 gap-3 items-center text-lg font-semibold text-red-500 text-center">
                        <p className="">
                    ...
                    <div className="grid grid-cols-2 p-6 pt-3 w-full">
                        ...
                        <div className="flex justify-end">
                            <button className="p-3 w-32 text-lg font-bold bg-red-700 rounded-3xl hover:bg-red-500"  onClick={ () => { confirmAction() } }>
                                Confirm
                            </button>
                        </div>
                    </div>
