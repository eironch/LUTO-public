...
import ApprovalIcon from '../assets/approve-icon.png'

function PostOverview(p) {
    return (
        <div className="grid grid-cols-12 min-h-auto mb-3 rounded-3xl bg-zinc-900 overflow-hidden">
            ...
            <div className="col-span-8 flex flex-col">
                <div className="flex flex-col w-full h-full gap-3">
                    <p className="mx-6 mt-6 text-zinc-100 text-3xl font-bold line-clamp-2">3 minute Homemade Vegetable Bowl! With Rice, Meat, Egg, Corn, Spinach, and Tomato With Rice, Meat, Egg, Corn, Spinach, and Tomato With Rice, Meat, Egg, Corn, Spinach, and Tomato With Rice, Meat, Egg, Corn, Spinach, and Tomato</p>
