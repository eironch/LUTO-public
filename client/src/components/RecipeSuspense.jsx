...
function RecipeSuspense() {
    return (
        <div className="grid grid-cols-12 mb-3 w-full rounded-3xl bg-zinc-800">
            <div className="flex flex-row w-full col-span-4 rounded-3xl p-2 shadow-zinc-900 shadow-right bg-zinc-600">
